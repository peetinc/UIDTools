...
# original https://github.com/samba-team/samba/blob/master/examples/misc/cldap.pl
# rewritten to only output whether or not DC is closest
...
sub dump_cldap_flags ($) {
	...
	printf(
		 "%s\n",
		 ($flags & $cldap_flags{ADS_CLOSEST}) ? "1" : "0");
}
